...
{
#ifdef PIN_BL
    ledc_set_duty(ledc_bl_channel.speed_mode, ledc_bl_channel.channel, (value * 1023) / 255);
...
static void BrightnessOutInit(void)
{
    ledc_timer_config_t ledc_timer = {
        ...
        .clk_cfg = LEDC_AUTO_CLK               // Ensure clock source is set
    };
    ...
    // Initialize LEDC fade service (if needed)
